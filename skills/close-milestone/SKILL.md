...
description: 某 Milestone 全部任务卡已关账、追踪矩阵满格,要做工作单元级验收与关账、回填 ROADMAP 时使用;用户说「这个里程碑做完了」「收尾/关账/验收M2」「可以发版了吗」时触发。
---
...
- **组合级读面审**:对本 Milestone 的跨卡合并 diff,由编排者调用内置 `/code-review`(max 档)审一次——卡级审不看跨卡组合,runtime 回归不看读面,此步补两者之间的空档(METHODOLOGY.md 5.2「跨卡的组合级问题留到关账审」的落点);findings 处置完才进对账。
