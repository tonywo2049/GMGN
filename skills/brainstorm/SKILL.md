---
name: brainstorm
description: 用户带着一个想法、问题或机会来,要开启一个新项目/新方向,而白皮书(WhitePaper)尚不存在或需要大改时使用;有白皮书要小修、或纯闲聊探讨不落项目的,不触发。
---
...
白皮书即 README 2.A 目标层顶层文档的具名化;定名与七项要求系负责人 2026-07-18 裁决(取代旧「三问自搭、不强定骨架」口径)。
...
文档契约(元信息块/docstar 写法)见 [文档写作契约](../methodology/references/文档写作契约.md);性质=规范,下游=ROADMAP(建成后同批补链)。

## 出口

自检四问(有无占位符/内部矛盾/范围缺口/歧义)→ 按 [critic-任务书](../methodology/references/critic-任务书.md) 派独立 critic 一轮 → 按任务书两护栏处置 → 附最薄弱假设三行呈负责人批准 → 落盘 commit → **REQUIRED 下一环:`roadmap`**。
