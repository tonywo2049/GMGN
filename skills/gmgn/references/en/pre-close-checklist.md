...
8. **Findings and risk** — Are material structural findings classified as target blockers or
   proved pre-existing external debt, and are remaining risks stated without invention?
9. **Acceptance** — Is owner acceptance bound to the exact closing anchor?
