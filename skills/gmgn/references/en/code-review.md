...
candidate. One return ends the Reviewer. The primary orchestrator adjudicates findings,
checks accepted fixes, and runs affected machine checks without another Reviewer round.
