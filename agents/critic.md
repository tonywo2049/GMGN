...
The terminal return contains material findings or explicit no-findings coverage and conflicts
needing a ruling. It ends this semantic candidate batch's only Critic round.
