...
- ROADMAP：Milestone 顺序、优先级和跨 Milestone 依赖。
- Goal：一个已启动 Milestone 的目标与边界。
...
1. 所有范围内 AC 已完成，或在新权威锚上完成语义删除/转移；
2. 每条保留判据都有可重放证据；
3. Task、Card/Log、追踪关系和 ROADMAP 同批刷新；
4. 负责人验收绑定关账锚。
