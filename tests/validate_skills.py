...
def validate_core_contract(errors: list[str]) -> None:
    ...
    require(run_task, (
        ...
        "authorized, the CLI is available, and the workspace has no `.codegraph/`",
        "run `codegraph init <workspace>`\nonce before source discovery",
        "confirm that a query can use the index",
        ...
        "record the reason and targeted-read fallback in the brief",
